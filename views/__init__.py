...
from .con_views import show_contracts, add_contract, update_contract
...
__all__ = [login, register, show_clients, add_client, update_client, show_contracts, add_contract, update_contract, show_events, add_event, 
